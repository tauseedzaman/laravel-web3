        ...
        @else
            <div class="container p-8 mx-auto mt-8">
                <div class="max-w-md p-8 mx-auto bg-white rounded-md shadow-md">
                    <h2 class="mb-4 text-2xl font-bold"><b>TTN</b> Token Purchase</h2>
                    ...
                    <form wire:submit.prevent="buyTokens">
                        ...
                        <button type="submit"
                            class="px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-700 focus:outline-none">
                            Get Tokens
                        </button>
                    </form>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($userTokens as $userToken)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $userToken->token_address }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $userToken->balance }} TTN Tokens
                                        </td>
